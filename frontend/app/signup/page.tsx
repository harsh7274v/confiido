              ...
              <div className="mb-6">
                <div className="inline-flex rounded-full p-0.5" style={{ backgroundColor: '#948979' }}>
                  <button
                    ...
                    className={`px-6 py-1.5 text-sm rounded-full font-medium transition-all duration-300 ${selectedCategory === 'student'
                  ...
                  <button
                    ...
                    className={`px-6 py-1.5 text-sm rounded-full font-medium transition-all duration-300 ${selectedCategory === 'professional'
                      ? 'bg-black text-white shadow-sm'
                      : 'text-white/90 hover:text-white'
                      }`}
                  >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2 bg-white border rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 placeholder-gray-500 disabled:opacity-50 disabled:cursor-not-allowed ${formData.email && !isValidEmailForSupport(formData.email) ? 'border-red-400' : 'border-gray-300'
                      }`}
                  />
                </div>
