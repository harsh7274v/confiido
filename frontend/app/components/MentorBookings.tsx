...
const MentorBookings: React.FC = () => {
  ...
  }, [user?.user_id, statusFilter, currentPage]);
  ...
  const fetchBookings = async () => {
    ...
    try {
      const response = await bookingApi.getExpertBookings(
        user.user_id,
      ...
      if (response.success) {
        console.log('🔍 [FRONTEND] Bookings data:', response.data.bookings);
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-600">
            {statusFilter ? `No ${statusFilter} bookings found.` : 'You don\'t have any bookings yet.'}
          </p>
        </div>
      ) : (
        <>
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {bookings.map((booking, index) => (
                    <tr key={`${booking._id || 'booking'}-${index}`} className="hover:bg-gray-50">
